        ...
        <div className="py-4 space-y-4">
            <div
                className={cn(
                    ...
                    "flex items-center justify-center text-2xl leading-normal", // Ensures vertical centering
            ...
            >
                ...
                <Textarea
                    ...
                    className={cn(
                        ...
                        "text-center text-2xl font-mono leading-normal",
                        "resize-none border-none bg-transparent text-transparent",
