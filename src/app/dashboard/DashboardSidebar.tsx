...
const menuItems = [
    ...
    { href: "/dashboard/ace-os", label: <>Ace OS<span className="copyright-symbol">©</span></>, icon: BookCopy },
                ...
                <div className="flex items-center gap-4">
                    <SidebarHeader className="p-0">
                         <a href="/" className="flex items-center gap-2">
                            ...
                            <span className="font-bold text-lg whitespace-nowrap">AP Ace<span className="copyright-symbol">©</span></span>
                        </a>
                    </SidebarHeader>
    ...
    return (
        <>
            <SidebarHeader>
                 <a href="/" className="flex items-center gap-2">
                    <AceMascot className="w-8 h-8 flex-shrink-0" />
                    <span className="font-bold text-lg whitespace-nowrap transition-opacity duration-500 group-data-[state=collapsed]:opacity-0">AP Ace<span className="copyright-symbol">©</span></span>
                </a>
            </SidebarHeader>
            <SidebarContent>
                <SidebarMenu>
    ...
    return (
        <div data-state={state} className={cn(
            ...
            <div className={cn(
                ...
                <p className="font-semibold text-sm truncate whitespace-nowrap">{user.displayName || <>AP Ace<span className="copyright-symbol">©</span> Student</>}</p>
